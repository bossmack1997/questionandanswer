...
- **Unbiased Fisher-Yates Randomization**:
  - Questions are randomized *within* each task (Task boundaries remain intact).
  - Answer choices are randomized *within* each question while preserving the stable correct answer identifier.
...
> **Note on Demo Mode:** When running without Firebase credentials, the system automatically uses an intelligent LocalStorage fallback. You can test the Teacher Portal immediately using the demo credentials:
> - **Email**: `teacher@school.edu`
> - **Password**: `english10pass`
